...
export const catalog: CatalogProduct[] = [
  ...
  p('apple-iphone-17e-128','phone','iPhone 17e','128GB',{storage_gb:128},'https://www.apple.com/shop/buy-iphone/iphone-17e',false),
  p('apple-iphone-17e-256','phone','iPhone 17e','256GB',{storage_gb:256},'https://www.apple.com/shop/buy-iphone/iphone-17e'),
...
export const merchants: MerchantSeed[] = [
  ...
  { id:'walmart', name:'Walmart', verified:true, authorized:true, trust_score:0.90, source_type:'marketplace', shipping_reliability:0.90, marketplace_seller:false, notes:'Only exact-SKU Walmart.com first-party offers are accepted; third-party marketplace sellers remain excluded.' },
  { id:'target', name:'Target', verified:true, authorized:true, trust_score:0.86, source_type:'retailer', shipping_reliability:0.90, marketplace_seller:false, notes:'First-party Target PDPs are accepted; absent offer-scoped seller markup is labeled as inferred from the retailer-owned PDP.' },
  { id:'bh-photo', name:'B&H Photo', verified:true, authorized:true, trust_score:0.86, source_type:'retailer', shipping_reliability:0.90, marketplace_seller:false, notes:'First-party B&H PDPs are accepted; absent offer-scoped seller markup is labeled as inferred from the retailer-owned PDP.' },
  { id:'adorama', name:'Adorama', verified:true, authorized:true, trust_score:0.86, source_type:'retailer', shipping_reliability:0.90, marketplace_seller:false, notes:'Exact-SKU first-party Adorama PDP offers are accepted with structured seller evidence.' }
];
